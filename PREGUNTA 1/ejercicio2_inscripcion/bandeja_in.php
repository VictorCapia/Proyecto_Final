...
<a href="cerrar_sesion.php"><button class="boton2">Terminar</button></a>
...
<?php
    ...
    echo "<div class='titulo'><h1>Bienvenido Usuario: " . $usu."</h1></div><br>";

    $sql = "SELECT * FROM flujotramite WHERE usuario='".$usu."' AND fechafin is null AND proceso != ''";
    $resultado = mysqli_query($con, $sql);
?>
    
    <a href="nuevo.php?usu=<?php echo $usu; ?>"><button class="boton2">Nuevo</button></a>
